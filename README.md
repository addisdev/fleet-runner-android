# fleet-runner-android has moved

This code now lives in **[addisdev/fleet-runner](https://github.com/addisdev/fleet-runner)**,
in the [`runner-android/`](https://github.com/addisdev/fleet-runner/tree/main/runner-android) directory.

The Android agent: a foreground service with llama.cpp (NDK/JNI) and LiteRT backends.
